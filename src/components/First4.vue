...
const cvURL =
  "https://14h02m10s.github.io/Portfolio3-14h/cv-porfolio-nov2024.pdf";
</script>
...
.englobeur-first {
  /* background: #1a1e36;
  background: linear-gradient(to top, #242949, #1a1e36 50%, #1a1e36 50%); */
  background: #fff;
...
.text {
  ...
  align-items: start;
  gap: 0.8rem;
  /* border-top: #c5b2a9 3px solid;
  border-top: #1a1e36 3px solid; */
  padding: 1.5rem 0;
  /* border-bottom: #c5b2a9 3px solid;
